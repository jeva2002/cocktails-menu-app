...
const TablesList: React.FunctionComponent<Props> = ({
  ...
  return (
    <>
      ...
      <section className='scroll-view d-flex flex-wrap justify-content-evenly px-md-5 px-2 pt-2'>
        {tablesList.map((e) => (
          <article
            className='d-flex flex-column align-items-center gap-2 m-1 p-2 pointer border rounded col-6 col-sm-4 '
            style={{
              cursor: 'pointer',
              width: 150,
              height: 175,
